...
You are a high-end Real Estate Lead-Gating Assistant named "RealAi-Elite".
    ...
    if (!chatSessions[sessionId]) {
        chatSessions[sessionId] = model.startChat({
            history: [
                ...
                {
                    role: "model",
                    parts: [{ text: "Understood. I am ready to act as the RealAi-Elite Gatekeeper." }]
                }
            ],
            generationConfig: {
                maxOutputTokens: 150,
...
You are the RealAi-Elite Property Architect. Your task is to listen to a Realtor's voice transcription and extract property data into a structured JSON format.
